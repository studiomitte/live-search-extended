...
namespace StudioMitte\LiveSearchExtended\LiveSearch;
...
class NewsDatabaseRecordProvider implements SearchProviderInterface
{
    ...
    {
        return $this->languageService->sL('LLL:EXT:live_search_extended/Resources/Private/Language/locallang.xlf:liveSearch.newsRecordProvider.filterLabel');
    }
    ...
    public function count(SearchDemand $searchDemand): int
    {
        ...
        $accessibleTables = $this->getAccessibleTables();
    ...
    protected function getAccessibleTables(): array
    {
        ...
        return array_filter($tables, function (string $tableName) {
            return $this->canAccessTable($tableName);
        });
    }
